...
- **增加修改删除容器记录（分配容器到设备、容器关联药品信息）**
- **导出容器记录**
- **批量编辑容器信息**

#### 药品信息管理 Vessel Infos

> 在左侧边栏中 点击 **Lab->Vessel Infos**进入到药品信息管理页面

> In the left sidebar, click **Lab->Vessel Infos** to go to the Vessel information management page

![](../../public/images/vessel-info-1.png)
